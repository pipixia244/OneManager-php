...
<style type="text/css">
        body{font-family:\'Helvetica Neue\',Helvetica,Arial,sans-serif;font-size:14px;line-height:1em;color:#000;background-color:#f7f7f9;background-repeat:no-repeat;background-size:cover;background-attachment:fixed;background-image:url("https://od.srpr.cc/sust0/mashiro2.jpg");}
        ...
        .list-container{position:relative;/*overflow:hidden;*/border-radius:15px;background-color:rgba(245,245,245,1);}
        ...
        .list-body-container{position:relative;left:0;box-sizing:border-box;/*overflow-x:hidden;overflow-y:auto;background:rgba(245,245,245,1)*/}
        ...
        @media only screen and (orientation: portrait){
            ...
            body{background-repeat:no-repeat;background-size:cover;background-attachment:fixed;background-image:url("https://od.srpr.cc/sust0/mashiro2.jpg");}
...
<div style="padding:10px" id="top-div"></div>
  ...
  <div class="container-sm">
    <div class="row">
      <section class="d-flex flex-column justify-content-center align-items-center w-100 error-message">
        <div style="padding:4px" id="top-div"></div>
        <h3 class="error-code">' . $title . '</h3>
        ' . $message . '
         <div style="padding:8px" id="top-div"></div>
...
';
    ...
    <div class="container d-flex justify-content-md-between justify-content-center">
      <div class="text-center main-footer-copyright">
        <p>Powered by <a href="https://github.com/qkqpttgf/OneManager-php" rel="noopener nofollow" target="_blank">OneManager</a>.
        </p>
      </div>
